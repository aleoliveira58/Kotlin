...
fun main() {
    ...
    val scanner = Scanner(System.`in`) // codigo para usuario falar com terminal
    val ingressoUm = scanner.nextInt() // codigo para ususario falar com terminal
    ...
    when (ingressoUm) {
        ...
        2 -> { println(
            ...
            if (tipoVip == 1) {
                ...
                println("Tudo OK, o valor do ingresso no " +
                            ...
                            "camarote superior é ${superior.valorIngresso()} reais") } else {
        ...
        else -> { println("Você digitou um valor inválido") } } }
...
open class Vip(
    ...
    val valorAdicional: Double = 0.0) : Ingresso() {

    fun valorIngresso(): Double {
        return valorReais + valorAdicional } }

class Normal(
    override val valorReais: Double) : Ingresso() {
...
class CamaroteSuperior(
    valorReais: Double,
    valorAdicional: Double) : Vip(valorReais, valorAdicional)
